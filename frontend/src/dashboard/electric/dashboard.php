...
<body class="bg-[#03041A] text-white antialiased h-screen overflow-hidden flex">
    ...
    <nav id="sidebar" class="flex flex-col fixed lg:sticky top-0 h-screen w-[280px] lg:w-[320px] 
        ...
        <div class="flex flex-col gap-1.5">
            ...
            <span class="text-[10px] font-black tracking-widest text-white/30 px-3 mb-1 uppercase"></span>
        ...
        <div class="mt-auto mb-6">
            <div
                class="flex items-center justify-between gap-3 px-4 py-3 rounded-2xl bg-[#31324C]/20 border border-white/5">
                <div class="flex items-center gap-3 truncate">
                    <div
                        class="h-10 w-10 rounded-xl overflow-hidden border border-[#FFBB02]/30 bg-[#1A1B3A] flex-shrink-0">
                ...
                <a href="<?= BACKEND_URL ?>/public/logout.php"
                    class="p-2 text-[#B5B5B5] hover:text-[#CB3435] transition-colors"><svg class="w-5 h-5" fill="none"
    ...
    <!-- MAIN CONTENT -->
    <main class="flex-1 overflow-y-auto custom-scrollbar flex flex-col w-full bg-[#03041A]">
        ...
        <header
            ...
            <div class="space-y-1">
                ...
                <h1 class="text-2xl lg:text-3xl font-black tracking-tight leading-tight">
                    Welcome Back,
                    <span class="text-[#FFBB02]">
                        <?= htmlspecialchars(explode(' ', $user['name'] ?? 'Admin')[0]) ?>
                    </span>
                </h1>

                <div class="flex items-center gap-1.5 text-[#B5B5B5]">

                    <span class="relative flex h-2 w-2">
                        <span class="animate-ping absolute h-full w-full rounded-full bg-[#00BA00] opacity-75"></span>
                        <span class="relative rounded-full h-2 w-2 bg-[#00BA00]"></span>
                    </span>
            ...
            <div
                class="text-xs sm:text-sm font-medium text-[#B5B5B5] bg-[#31324C]/20 px-3 sm:px-4 py-2 rounded-lg border border-white/5">
        ...
        <!-- DASHBOARD BODY -->
        <div class="px-4 lg:px-10 py-8 flex flex-col gap-8">
            <section class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Active Outages Card -->
                <div
                    class="bg-[#31324C]/20 border border-white/5 rounded-3xl p-8 min-h-[160px] flex flex-col gap-4 relative overflow-hidden group">
                    <div class="text-[#CB3435]">
                        <svg class="w-8 h-8" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" />
                        </svg>
                    </div>
                    <div class="flex flex-col">
                        <span id="activeOutages" class="text-white text-5xl font-black tracking-tighter">0</span>
                ...
                <div
                    ...
                    <div class="flex flex-col">
                        <span id="resolvedOutages" class="text-white text-5xl font-black tracking-tighter">0</span>
            ...
            <section class="flex flex-col gap-6">
                <div class="rounded-2xl border border-white/5 overflow-hidden shadow-xl bg-[#31324C]/20 flex flex-col">
                    <div class="flex justify-between items-center p-6 border-b border-white/5 bg-[#16172E]/40">
                        <span class="font-bold">System Outage Map</span>
                        <span
                            class="text-[#00BA00] px-3 py-1 bg-[#00BA00]/10 text-xs rounded-lg font-bold border border-[#00BA00]/20">LIVE</span>
                    </div>
                    <div class="relative w-full h-80 lg:h-[430px]">
            ...
            <section class="w-full">
                <div class="rounded-2xl border border-white/5 bg-[#31324C]/20 flex flex-col p-6 shadow-xl">
                    <span class="text-white text-xs font-bold uppercase tracking-widest opacity-60 mb-6">Latest
                        Reports</span>
                    <div id="list"
                        class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 flex-1 overflow-y-auto custom-scrollbar max-h-[400px]">
                    </div>
                </div>
            </section>
        </div>
    ...
    function renderMapMarkers(reports) {
        ...
        reports.forEach(r => {
            ...
            /* =======================
               COLOR LOGIC (FIXED)
            ======================= */
            const severity = String(r.severity || "").toLowerCase().trim();

            let markerColor = "#FFD400"; // default
