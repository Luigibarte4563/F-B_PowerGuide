...
<body class="bg-[#03041A] text-white antialiased">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <nav id="sidebar" class="flex flex-col fixed lg:sticky top-0 h-screen w-[280px] lg:w-[340px]
            ...
            <!-- Profile Info Panel Inside Navigation -->
            <div
                class="flex flex-row items-center gap-3 px-4 py-3 mb-6 rounded-2xl bg-[#31324C]/20 border border-white/5 text-left">
            ...
            <!-- Pro Tip -->
            <div
                class="flex flex-col text-left mt-auto mb-8 mx-2 p-5 rounded-2xl bg-[#31324C]/30 border border-white/5">
