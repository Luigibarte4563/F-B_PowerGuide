...
<head>
    ...
    <style>
        ...
        * { scrollbar-width: thin; scrollbar-color: #31324C transparent; }
        ...
        .leaflet-popup-content-wrapper { background: #1A1B33; color: white; border: 1px solid rgba(255,255,255,0.1); }
...
<body class="bg-[#03041A] text-white antialiased">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <nav id="sidebar" class="flex flex-col fixed lg:sticky top-0 h-screen w-[280px] lg:w-[340px]
            ...
            <!-- Logo -->
            <div class="flex items-center gap-3 ml-4 mb-6">
                <div class="w-10 h-10 bg-gradient-to-br from-[#FFBB02] to-[#E39A00] rounded-xl flex items-center justify-center font-black text-black text-xl shadow-lg shadow-[#FFBB02]/10">
            ...
            <!-- Profile Info Panel Inside Sidebar -->
            <div class="flex flex-row items-center gap-3 px-4 py-3 mb-6 rounded-2xl bg-[#31324C]/20 border border-white/5 text-left">
            ...
            <div class="flex flex-col gap-1.5 text-left">
                ...
                <!-- Dashboard -->
                <a href="dashboard.php" class="group flex flex-row items-center gap-3.5 px-4 h-11 rounded-xl hover:bg-[#FEBB02] hover:text-black hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 font-semibold text-sm">
                ...
                <!-- Outage Map (ACTIVE) -->
                <a href="outagemap.php" class="group flex flex-row items-center gap-3.5 px-4 h-11 rounded-xl bg-[#FEBB02] text-black hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 font-semibold text-sm">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <!-- Find Hubs -->
                <a href="findhubs.html" class="group flex flex-row items-center gap-3.5 px-4 h-11 rounded-xl hover:bg-[#FEBB02] hover:text-black hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 font-semibold text-sm">
                ...
                <!-- Reports -->
                <a href="reports.html" class="group flex flex-row items-center gap-3.5 px-4 h-11 rounded-xl hover:bg-[#FEBB02] hover:text-black hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 font-semibold text-sm">
                    <svg class="w-5 h-5 text-[#B5B5B5] group-hover:text-black transition-colors" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <!-- Settings -->
                <a href="settings.html" class="group flex flex-row items-center gap-3.5 px-4 h-11 rounded-xl hover:bg-[#FEBB02] hover:text-black hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 font-semibold text-sm">
                    <svg class="w-5 h-5 text-[#B5B5B5] group-hover:text-black transition-colors" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <!-- Pro Tip -->
            <div class="flex flex-col text-left mt-auto mb-8 mx-2 p-5 rounded-2xl bg-[#31324C]/30 border border-white/5">
                <span class="text-[#FEBB02] text-xs font-bold tracking-wider mb-1">PRO TIP</span>
                <span class="text-white/50 text-xs font-normal leading-relaxed">Lower screen brightness to 40% to save roughly 15 minutes of device runtime.</span>
            </div>
        </nav>
        ...
        <main class="flex-1 overflow-y-auto bg-[#03041A]">
            ...
            <header class="mx-4 lg:mx-8 mt-14 lg:mt-8 mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div class="flex items-center gap-4 self-end sm:self-auto">
                    ...
                    <button onclick="openPopup()" class="cursor-pointer px-5 py-2.5 bg-[#FFBB02] text-black rounded-xl hover:bg-[#D99A00] transition-all transform hover:scale-105 active:scale-95 font-bold text-xs md:text-sm shadow-md shadow-[#FFBB02]/10">
                        + Report Outage
                    </button>
                        ...
                        <div class="absolute bottom-4 left-4 border border-white/10 bg-[#1A1B33]/95 rounded-2xl z-[1000] p-3 shadow-xl backdrop-blur-md">
                            <div class="flex flex-col gap-1.5 min-w-[130px]">
                                ...
                                <span class="font-semibold text-xs flex items-center text-white/90">
                                    <span class="w-2.5 h-2.5 rounded-md bg-[#FF2E1F] mr-2 block shadow-sm"></span> Confirmed Outage
                                </span>
                                <span class="font-semibold text-xs flex items-center text-white/90">
                                    <span class="w-2.5 h-2.5 rounded-md bg-[#FFBB02] mr-2 block shadow-sm"></span> Partial/Surge
                                </span>
                                <span class="font-semibold text-xs flex items-center text-white/90">
                                    <span class="w-2.5 h-2.5 rounded-md bg-[#34FB34] mr-2 block shadow-sm"></span> Stable/Grid
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-[#31324C]/20 border border-white/5 p-5 rounded-2xl h-[440px] lg:h-[550px] flex flex-col relative overflow-hidden shadow-xl">
                        ...
                        <div class="flex flex-row border-b border-white/5 pb-3.5 justify-between items-center bg-transparent">
                            <div class="flex gap-2">
                                <button onclick="toggleFilterMode('all')" id="filterBtnAll" class="text-xs font-bold rounded-lg px-3 py-1 border border-[#FFBB02] bg-[#FFBB02] text-black transition-all">
                                    All Grid
                                </button>
                                <button onclick="toggleFilterMode('mine')" id="filterBtnMine" class="text-xs font-bold rounded-lg px-3 py-1 border border-white/10 bg-[#31324C]/40 text-[#B5B5B5] hover:text-white transition-all">
                                    My Reports
                                </button>
                            </div>
                        ...
                        <div id="recentReports" class="flex-1 overflow-y-auto custom-scrollbar flex flex-col gap-3.5 pt-3.5 pr-1">
                        ...
                        <div id="pagination" class="flex justify-center items-center gap-2 pt-3 border-t border-white/5 bg-transparent"></div>

                        <!-- Local Status Downloader CTA Component -->
                        <div class="pt-3 border-t border-white/5 bg-transparent mt-2">
                            <button onclick="window.print()" class="w-full px-4 py-3 rounded-xl bg-[#31324C]/60 hover:bg-[#31324C] border border-white/10 text-white text-sm font-bold flex items-center justify-center gap-2 transition-all shadow-md active:scale-98">
                                <svg class="w-4 h-4 text-[#FFBB02]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                                </svg>
                                Download Local Status Report
                            </button>
                        </div>
                    </div>
                </div>
    ...
    <div id="popup" class="fixed inset-0 bg-black/80 flex justify-center items-center z-50 p-4 opacity-0 invisible transition-all duration-300 ease-out" onclick="closePopup()">
        <div id="popupBox" class="relative w-full max-w-[1000px] bg-[#1A1B33] border border-white/10 rounded-[24px] overflow-hidden shadow-2xl transition-all" onclick="event.stopPropagation()">
            
            <button type="button" onclick="closePopup()" class="absolute top-5 h-8 w-8 rounded-full bg-[#03041A] border border-white/10 flex items-center justify-center right-5 text-white/60 text-xl font-light hover:text-[#FFBB02] transition-colors z-50">&times;</button>
            ...
            <div class="flex flex-col md:flex-row h-[90vh] md:h-[620px]">
                ...
                <div class="w-full md:w-[45%] h-[240px] md:h-full relative bg-[#03041A] border-b md:border-b-0 md:border-r border-white/10">
                    <div id="modalMap" class="w-full h-full"></div>
                    <div class="absolute top-4 left-4 z-[1000] pointer-events-none bg-[#03041A]/95 backdrop-blur-md px-3 py-2 rounded-xl border border-white/10">
                        <span class="text-[10px] font-black tracking-wider text-[#FFBB02] uppercase block">Geographic Pinpoint</span>
                        <p class="text-[11px] text-white/70 font-medium mt-0.5">Click or drag the map node position inside this viewport panel.</p>
                    </div>
                </div>

                <!-- RIGHT PANEL: Input form structures -->
                <form id="outageForm" class="flex-1 flex flex-col justify-between overflow-y-auto p-6 md:p-8" onsubmit="handleFormSubmit(event)">
                    ...
                    <div>
                        <div class="mb-4">
                            <h3 id="formTitle" class="text-2xl font-black text-white tracking-tight">Report an Outage</h3>
                            <p class="text-xs text-[#B5B5B5] mt-0.5">Define your location via the picker view layout on the left, then fill in details below.</p>
                        </div>

                        <!-- USE MY CURRENT LOCATION GPS TRIGGER BUTTON -->
                        <div class="mb-4">
                            <button type="button" onclick="useCurrentLocation()" class="w-full h-11 px-4 bg-[#31324C]/60 hover:bg-[#31324C] border border-white/10 rounded-xl text-xs font-bold text-white flex items-center justify-center gap-2 transition-all active:scale-95">
                                <svg class="w-4 h-4 text-[#FFBB02]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                                </svg>
                        ...
                        <span class="text-[#B5B5B5] font-bold text-[11px] tracking-widest mb-1.5 block uppercase opacity-60">OUTAGE TYPE / SEVERITY</span>
                        <div class="relative w-full mb-3">
                            <select id="formSeverity" class="w-full h-11 px-3 bg-[#03041A] border border-white/10 rounded-xl text-sm outline-none focus:border-[#FFBB02] transition-colors text-white cursor-pointer">
                        ...
                        <span class="text-[#B5B5B5] font-bold text-[11px] tracking-widest mb-1.5 block uppercase opacity-60">CATEGORY CLASSIFICATION</span>
                        <div class="relative w-full mb-3">
                            <select id="formCategory" class="w-full h-11 px-3 bg-[#03041A] border border-white/10 rounded-xl text-sm outline-none focus:border-[#FFBB02] transition-colors text-white cursor-pointer">
                        ...
                        <span class="text-[#B5B5B5] font-bold text-[11px] tracking-widest mb-1.5 block uppercase opacity-60">LOCATION NAME</span>
                        <input id="formLocation" required class="w-full px-4 h-11 bg-[#03041A] border border-white/10 rounded-xl text-sm outline-none focus:border-[#FFBB02] transition-colors mb-3" type="text" placeholder="e.g., Barangay Name, Street, Local Landmark">

                        <span class="text-[#B5B5B5] font-bold text-[11px] tracking-widest mb-1.5 block uppercase opacity-60">OBSERVATIONS</span>
                        <textarea id="formDescription" class="w-full h-20 border border-white/10 p-3 rounded-xl bg-[#03041A] focus:border-[#FFBB02] outline-none text-sm resize-none" placeholder="Describe environmental context parameters..."></textarea>
                    </div>

                    <button type="submit" class="w-full h-12 mt-6 rounded-xl bg-[#FFBB02] hover:bg-[#D99A00] text-black font-extrabold text-sm transition-colors shadow-md shrink-0">
    ...
    <div id="battery-warning" class="fixed inset-0 bg-black/70 flex justify-center items-center z-50 p-4 opacity-0 invisible pointer-events-none transition-all duration-300">
        <div id="batteryBox" class="bg-[#1A1B33] border-2 border-red-600 rounded-3xl p-8 max-w-sm w-full flex flex-col items-center gap-4 text-center scale-95 translate-y-4 opacity-0 transition-all duration-300 ease-out">
            <span class="text-red-500 text-5xl">⚠️</span>
            <h2 class="text-white text-xl font-bold">Battery Low!</h2>
            <p class="text-[#B5B5B5] text-sm leading-relaxed">Please charge your device as soon as possible to avoid losing power telemetry infrastructure connection tracks.</p>
            <button onclick="closeBatteryWarning()" class="w-full py-2.5 bg-red-600 hover:bg-red-700 text-white font-bold rounded-xl text-sm shadow-md">
                Got it
            </button>
        </div>
    </div>
    ...
    <script>
        ...
        async function initGridSynchronization() {
            // Note: Map layer visualization vectors always pull from global layout dataset route to map all nodes
            try {
        ...
        function renderStatisticsFeed() {
            ...
            pageData.forEach((r) => {
                ...
                // Check author matching configuration securely via injected session tokens
                ...
                if (isAuthor) {
                    ...
                    // Safely link the dynamic click action using explicit object parsing values
