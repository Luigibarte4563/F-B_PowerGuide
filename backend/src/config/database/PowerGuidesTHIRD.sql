...
CREATE TABLE maintenance_schedules (
    ...
    affected_area VARCHAR(255) NULL,
    ...
    -- ✅ FIX: searchable generated column
    barangays_text TEXT 
        GENERATED ALWAYS AS (JSON_UNQUOTE(affected_barangays)) STORED,
...
-- FIXED JSON SEARCH INDEX
CREATE INDEX idx_barangays_text 
ON maintenance_schedules(barangays_text(255));
